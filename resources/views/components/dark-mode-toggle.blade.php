<flux:tooltip content="Toggle Dark Mode">
    <div x-data="darkModeToggle()" x-init="initialize()"
        ...
        <svg x-show="!isDarkMode" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path class="text-zinc-600" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <svg x-show="isDarkMode" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path class="text-zinc-400" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
